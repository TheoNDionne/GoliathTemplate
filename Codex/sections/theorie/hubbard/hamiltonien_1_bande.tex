...
% \begin{aligned}
%         \mathrm{c}^\dag_{i\sigma} &= \frac{1}{\sqrt{N}}\sum_\ve{k}\Exp{-i\ve{k}\cdot\ve{r}_i}\mathrm{c}^\dag_{\ve{k}\sigma} & \mathrm{c}_{i\sigma} &= \frac{1}{\sqrt{N}}\sum_\ve{k}\Exp{i\ve{k}\cdot\ve{r}_i}\mathrm{c}_{\ve{k}\sigma}\label{eq:op_creat_anni_fourier}
% \end{aligned}

\begin{figure}
    \centering
    \scalebox{2.5}{
    \input{figures/tikz/hubbard_1_band.tikz}
    }
