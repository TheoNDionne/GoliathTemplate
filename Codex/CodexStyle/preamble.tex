...
\newcommand{\CodexLanguage}{french} % set language
\newcommand{\CodexColorTheme}{CodexStyle/colorthemes/colors_marine} % set colortheme (path to desired .sty)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                Language Support               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[\CodexLanguage]{babel} % language support priority language last
...
%%% Choose color theme
\usepackage{\CodexColorTheme} % choose a style
