%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%----------------Language Support---------------
\usepackage[english]{babel} % language support priority language last
...
%%% Choose color theme
\usepackage{CodexStyle/colorthemes/colors_sherbrooke} % choose a style
...
\@ifclassloaded{beamer}{ %%% BEAMER %%%
    \usepackage{CodexStyle/theme/presentation_layout} % load presentation
}{
    \PackageError{mydoc}
